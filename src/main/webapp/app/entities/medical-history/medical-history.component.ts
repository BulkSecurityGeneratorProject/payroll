...
export class MedicalHistoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.medicalHistoryService
            ...
            .subscribe(
                (res: HttpResponse<IMedicalHistory[]>) => this.paginateMedicalHistories(res.body, res.headers),
    ...
    trackId(index: number, item: IMedicalHistory) {
        return item.id;
    }
    ...
    protected paginateMedicalHistories(data: IMedicalHistory[], headers: HttpHeaders) {
