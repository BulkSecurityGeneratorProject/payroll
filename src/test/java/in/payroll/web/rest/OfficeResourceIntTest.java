...
public class OfficeResourceIntTest {
    ...
    public void createOffice() throws Exception {
        ...
        assertThat(testOffice.getCity()).isEqualTo(DEFAULT_CITY);
        assertThat(testOffice.getCityCategory()).isEqualTo(DEFAULT_CITY_CATEGORY);
        assertThat(testOffice.getPincode()).isEqualTo(DEFAULT_PINCODE);
        assertThat(testOffice.getTaluka()).isEqualTo(DEFAULT_TALUKA);
        assertThat(testOffice.getDistrict()).isEqualTo(DEFAULT_DISTRICT);
    }
    ...
    public void updateOffice() throws Exception {
        ...
        assertThat(testOffice.getCity()).isEqualTo(UPDATED_CITY);
        assertThat(testOffice.getCityCategory()).isEqualTo(UPDATED_CITY_CATEGORY);
        assertThat(testOffice.getPincode()).isEqualTo(UPDATED_PINCODE);
        assertThat(testOffice.getTaluka()).isEqualTo(UPDATED_TALUKA);
        assertThat(testOffice.getDistrict()).isEqualTo(UPDATED_DISTRICT);
    }
