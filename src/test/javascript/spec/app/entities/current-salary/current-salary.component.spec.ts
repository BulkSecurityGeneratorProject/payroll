...
import { CurrentSalaryComponent } from 'app/entities/current-salary/current-salary.component';
...
describe('Component Tests', () => {
    describe('CurrentSalary Management Component', () => {
        let comp: CurrentSalaryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CurrentSalaryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.currentSalaries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
