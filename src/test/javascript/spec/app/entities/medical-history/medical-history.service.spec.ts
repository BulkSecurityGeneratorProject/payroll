...
describe('Service Tests', () => {
    describe('MedicalHistory Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new MedicalHistory(0, currentDate, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a MedicalHistory', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        date: currentDate.format(DATE_FORMAT)
                ...
                service
                    .create(new MedicalHistory(null))
                    .pipe(take(1))
            ...
            it('should return a list of MedicalHistory', async () => {
                const returnedFromService = Object.assign(
                    {
                        date: currentDate.format(DATE_FORMAT),
                        currentValue: 1
